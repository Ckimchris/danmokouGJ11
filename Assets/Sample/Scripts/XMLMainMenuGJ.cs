...
{
    [Preserve]
    public class XMLMainMenuGJ : XMLMainMenu
    {
        ...
        public override void FirstFrame()
        {
            ...
            var defaultPlayer = game.Campaign.players[0];
            var defaultShot = defaultPlayer.shots2[1];
            var defaultSupport = defaultPlayer.supports[2];
