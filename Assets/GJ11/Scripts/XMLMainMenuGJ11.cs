...
{
    [Preserve]
    public class XMLMainMenuGJ11 : XMLMainMenu
    {
        ...
        public override void FirstFrame()
        {
            ...
            var reimu = game.Campaign.players[0];
            ShipConfig[] shipConfigs = new ShipConfig[1];
            shipConfigs[0] = reimu;

            var reimuShot = reimu.shots2[0];
            ShotConfig[] shotConfigs = new ShotConfig[2];
            shotConfigs[0] = reimuShot.shot;

            var defaultSupport = reimu.supports[0];
